...
toolbarBtn:"gutentyp-toolbar-btn",toolbarBtnText:"gutentyp-toolbar-btn-text",toolbarBtnIcon:"gutentyp-toolbar-btn-icon",toolbarGroup:"gutentyp-toolbar-group",toolbarComponents:"gutentyp-toolbar-components",toolbarForms:"gutentyp-toolbar-forms",toolbarArrowOver:"gutentyp-toolbar-arrow-over",hidden:"gutentyp-hidden",form:"gutentyp-form"};b.autoCreateSelectors=function(){var c;b.selectors={};for(c in b.cssClasses)b.cssClasses.hasOwnProperty(c)&&(b.selectors[c]="."+b.cssClasses[c]);b.selectors.newEditors=
b.selectors.editor+":not("+b.selectors.hasToolbar+")";b.selectors.eventlessEditors=b.selectors.editor+":not("+b.selectors.hasEvents+")";b.selectors.newToolbars=b.selectors.toolbar+":not("+b.selectors.hasComponents+")";b.selectors.newToolbarsFormsContainer=b.selectors.newToolbars+" "+b.selectors.toolbarForms;b.selectors.newToolbarsComponentsContainer=b.selectors.newToolbars+" "+b.selectors.toolbarComponents};b.autoCreateSelectors();return b}});hilary.register("gutentyp::dom",{init:function(b,c){var k,h,e,g,n,l,p,q,s,r,t,u,m;k=function(a,d,f,c,g){a=b("<"+(a||"div")+" />");d&&null!==d&&""!==d&&a.addClass("."===d[0]?d.substr(1):d);if("undefined"!==typeof f)for(d=0;d<f.length;d++)a.attr(f[d].key,f[d].value);"undefined"!==typeof c&&a.html(c);return g?a.prop("outerHTML"):a};h=function(a,d){return b(a).append(d)};e=function(a,d){return b(a).addClass(d)};g=function(a,d){return b(a).closest(d)};n=function(a,d){return b(a).siblings(d)};l=function(a,
...
d=a.anchorNode);!d&&document.selection&&(a=document.selection,a=a.getRangeAt?a.getRangeAt(0):a.createRange(),d=a.commonAncestorContainer?a.commonAncestorContainer:a.parentElement?a.parentElement():a.item(0));if(d)return"#text"===d.nodeName?d.parentNode:d};t=function(a){var d="",b;for(b=0;b<(a||5);b++)d+="abcdefghijklmnopqrstuvwxyz".charAt(Math.floor(26*Math.random()));return d};u=function(a,d,f){var c=b(a);a=c.offset();var e=c.outerWidth()/2;f=d?b(d):c;a.width=f.outerWidth();a.height=49<c.outerHeight()?
c.outerHeight():50;d&&(a.moveLeft=a.left+(e||25)-a.width/2,a.moveTop=a.top+2*e,a.moveRight=a.right+a.width/2-u(d).width/2,a.moveBottom=a.bottom+a.height+6);d=window.innerWidth;c=window.innerHeight;a.moveLeft+f.outerWidth()>d&&(a.moveLeft=d-f.outerWidth());a.moveTop+f.outerHeight()>c&&(a.moveTop=0<c-f.outerHeight()?c-f.outerHeight():0);return a};m=function(a,d){var f;f=b(a).is("form")?b(a):d&&b(a).hasClass(c.cssClasses.form)?b(a).find(":input"):d?b(a).closest(c.selectors.form).find(":input"):b(a).closest(c.selectors.form);
if(!f||1>f.length)f=b(a).find(c.selectors.form);return f};return{makeElement:k,initializeRichTextAreas:function(){var a=[];b(c.selectors.toGutentypify).each(function(d,f){var v=b(this);b("<div />").addClass(c.cssClasses.container).insertBefore(v).html(v);v.attr("id")||v.attr("id","gutentyp-"+t());b("<div />").addClass(c.cssClasses.editor).attr("data-for",v.attr("id")).html(v.val()).attr("contenteditable",!0).insertBefore(v);v.removeClass(c.cssClasses.toGutentypify);v.addClass(c.cssClasses.hidden);
v.addClass(c.cssClasses.gutentypified);a.push(v.attr("id"))});return a},insertNewElementBefore:function(a,d,f,c){d&&""!==d&&k(a,f,c).insertBefore(b(d))},insertNewElementInto:function(a,d,f,c){d&&""!==d&&("string"!==typeof a&&a.markup?b(a.markup).appendTo(b(d)):k(a,f,c).appendTo(b(d)))},insertHtmlBefore:function(a,d){return b(a).before(d)},insertHtmlAfter:function(a,d){return b(a).after(d)},setText:function(a,d){return b(a).text(d)},insertHtml:h,addClass:e,removeClass:function(a,d){return b(a).removeClass(d)},
toggleClass:function(a,d){return b(a).toggleClass(d)},getAttribute:function(a,d){return b(a).attr(d)},getOrSetValue:function(a,d){return d?(b(a).val(d),d):b(a).val()},clearForm:function(a){a=m(a);a.val("");a.is("textarea")&&a.html("");a.find(":input").val("");a.find("textarea").html("");return a.find(".alert").addClass(c.cssClasses.hidden)},getClosest:g,getClosestAdjacent:n,getEditor:function(a){return(a=b(a).parents(c.selectors.gutentyp).find(c.selectors.editor))?a[0]:null},getNext:function(a,d){return b(a).next(d)},
getPrevious:function(a,d){return b(a).prev(d)},exists:function(a){return 0<b(a).length},attachEvent:function(a){if(!a||!1===b.isFunction(a.eventHandler))return!1;var d=b(a.primarySelector);if(a.secondarySelector)d.on(a.eventType,a.secondarySelector,function(d){a.eventHandler(d.originalEvent)});else d.on(a.eventType,function(d){a.eventHandler(d.originalEvent)});return e(d,c.cssClasses.hasEvents)},triggerEvent:l,addChangeEventsToEditables:function(a,d){if(document.querySelectorAll&&"function"===typeof a){var b=
0,c=document.querySelectorAll("[contenteditable=true]");for(b;b<c.length;b++)"function"!==typeof c[b].onblur&&(c[b].onfocus=function(){this.data_orig=this.innerHTML},c[b].onblur=function(){if(d||this.innerHTML!==this.data_orig)a(this),this.data_orig=this.innerHTML})}},updateTextarea:function(a){var d=b("textarea#"+b(a).attr("data-for"));d.is("textarea")&&d.html(b(a).html());d.val(b(a).html());l(d[0],"change");return a},isFunction:function(a){return b.isFunction(a)},isObject:function(a){return b.isPlainObject(a)},
isArray:function(a){return b.isArray(a)},hasAncestor:function(a,d){return 0!==b(a).parents(d).length||"string"===typeof d&&b(a).hasClass(d)||"string"===typeof d&&b(a).hasClass(d.substring(1))?!0:!1},getSelectedText:function(){var a,d,b,c;if("undefined"!==typeof window.getSelection){if(a=window.getSelection(),a.rangeCount){d=document.createElement("div");b=0;for(c=a.rangeCount;b<c;++b)d.appendChild(a.getRangeAt(b).cloneContents());return d.innerHTML}}else if("undefined"!==typeof document.selection&&
"Text"===document.selection.type)return document.selection.createRange().htmlText},getSelectedParentNode:r,replaceSelectedText:function(a,d){if(window.getSelection)return p(window.getSelection(),a,d);if(document.selection)return p(document.selection,a,d)},pasteHtmlAtCursor:function(a,d,f){var e;window.getSelection?e=window.getSelection():(e=document.selection,"Control"===e.type&&(e=void 0));f&&0===b(r()).closest(c.selectors.editor).length&&(f=n(g(f.target,c.selectors.toolbar),c.selectors.editor).first(),
h(f,a));p(e,a,d)},pasteHtml:p,selectRange:s,selectionIsInEditor:function(a){return 0<b(r(a)).closest(c.selectors.editor).length},getCursorCoordinates:function(){var a=window.getSelection();return a.getRangeAt&&a.rangeCount?b.extend({isClone:!0},a,a.getRangeAt(0)):!1},getRandomString:t,getCoordinates:u,setStyle:function(a,d){return b(a).attr("style",d)},formToJson:function(a){a=m(a,!0);var d={},c;if(0!==a.length)return c=a.serializeArray(),b.each(c,function(){void 0!==d[this.name]?(d[this.name].push||
(d[this.name]=[d[this.name]]),d[this.name].push(this.value||"")):d[this.name]=this.value||""}),a.find(':input[disabled="disabled"]').each(function(a){a=b(this);var c=a.attr("name");c&&(d[c]=a.val())}),d}}}});hilary.register("gutentyp::pipeline",{init:function(b,c){var k=[],h=[],e={},g,n={beforeAny:k,afterAny:h,registerPipelineEvent:e};e.registerBeforeAnyHandler=function(b){if(!c.isFunction(b))throw Error("Only functions can be registered as beforeAny events.");k.push(b)};e.registerAfterAnyHandler=function(b){if(!c.isFunction(b))throw Error("Only functions can be registered as afterAny events.");h.push(b)};e.registerBeforeComponentHandler=function(c,e){g(b.prefixes.pipeline.beforeComponent+c,e)};e.registerAfterComponentHandler=
function(c,e){g(b.prefixes.pipeline.afterComponent+c,e)};g=function(b,e){if(!c.isFunction(e))throw Error("Only functions can be registered as pipeline events.");n[b]=e};return n}});hilary.register("gutentyp::components",{init:function(b,c,k){var h=[],e,g,n,l,p,q,s,r,t,u={},m;t=function(a){if(a instanceof Array)for(var b in a)a.hasOwnProperty(b)&&t(a[b]);else h.push(a)};q=function(a){c.attachEvent({primarySelector:document,secondarySelector:"."+a.cssClass,eventType:"click",eventHandler:function(d){var f=c.getClosest(d.target,"button");d="."+c.getAttribute(f,"data-for");var e;"toolbar"!==b.attachFormsTo&&(f=c.getCoordinates(f,d),e="left: "+f.moveLeft+"px",e+="; top: "+f.moveTop+
"px",c.setStyle(d,e));c.toggleClass(".gutentyp-toolbar-group.active:not(."+a.uniqueId+")","active");c.toggleClass(d,"active")}})};s=function(a,d){c.attachEvent({primarySelector:document,secondarySelector:"."+a.cssClass+"-form .btn-success",eventType:"click",eventHandler:function(f){var e=c.formToJson(f.target),g;if(c.isFunction(d)&&!d(f,e))return!1;g=c.getClosest(f.target,b.selectors.toolbarGroup);c.toggleClass(g,"active");f.fromGutenForm=!0;a.execute(f,e)}})};r=function(a){c.attachEvent({primarySelector:document,
secondarySelector:"."+a.cssClass+"-form .btn-cancel",eventType:"click",eventHandler:function(a){var f=c.getClosest(a.target,b.selectors.toolbarGroup);a=c.getClosestAdjacent(a.target,".alert");c.toggleClass(f,"active");c.clearForm(f);c.addClass(a,b.cssClasses.hidden)}})};e=function(a,b){var f=b.fields,e=0,h="",k={names:[]},q={},m={},r=c.getRandomString();for(e;e<f.length;e++)m["a"+e]=c.getRandomString(),h+=g(f[e],m["a"+e]),n(k,f[e],m["a"+e]);0<k.names.length&&(q.validate=l(k));return p(a,h,q,r)};g=
function(a,d){var f="",e;if(!a||!a.elementType||!a.name)return"";a.validation&&a.validation.message&&(e="alert "+b.cssClasses.hidden+" "+d,a.validation.cssClass&&(e+=" "+a.validation.cssClass),f+=c.makeElement("div",e,void 0,a.validation.message,!0));a.label&&(f+=c.makeElement("label",void 0,void 0,a.label,!0));e=c.isArray(a.attributes)?a.attributes:[];e.push({key:"name",value:a.name});"input"===a.elementType&&e.push({key:"type",value:a.inputType||"text"});f+=c.makeElement(a.elementType,a.cssClass||
void 0,e,void 0,!0);return f+"<br />"};n=function(a,b,f){b.name&&b.validation&&c.isFunction(b.validation.validate)&&(a.names.push(b.name),a[b.name]=b.validation,a[b.name].messageId=f)};l=function(a){return function(d,f){var e,g,h=!0;for(e=0;e<a.names.length;e++)(g=a[a.names[e]])&&c.isFunction(g.validate)&&g.messageId&&!g.validate(d,f)&&(h=!1,g=c.getClosestAdjacent(d.target,"."+g.cssClass),g.removeClass(b.cssClasses.hidden));return h}};p=function(a,d,f,e){a.uniqueId=e||c.getRandomString();u[a.pipelineName]||
(q(a),s(a,f&&f.validate),r(a),u[a.pipelineName]=!0);return{button:'<button type="button" class="'+a.cssClass+'" data-form-btn="true" data-for="'+a.uniqueId+'"><i class="'+b.cssClasses.toolbarBtnIcon+" "+a.icon+'"></i><span class="'+b.cssClasses.toolbarBtnText+' sr-only">'+a.title+"</span></button>",form:'<div class="clearfix '+b.cssClasses.toolbarGroup+" "+b.cssClasses.toolbarArrowOver+" "+a.uniqueId+" "+a.cssClass+'-form"><div class="'+b.cssClasses.form+'">'+d+'<button class="btn btn-success btn-sm" type="button">Add</button><button class="btn btn-cancel btn-sm" type="button">Cancel</button></div></div>',
uniqueId:a.uniqueId}};return{getComponents:function(){return h},makeComponent:function(a){var d={};d.title=a.title;d.cssClass=a.cssClass||a.pipelineName;d.pipelineName=a.pipelineName;d.icon=a.icon||void 0;d.textClass=a.textClass+" "+b.cssClasses.toolbarBtnText||b.cssClasses.toolbarBtnText;d.displayHandler=a.displayHandler;d.group=a.group||void 0;d.execute=function(d,e){var g,h=b.prefixes.pipeline.beforeComponent+a.pipelineName,l=b.prefixes.pipeline.afterComponent+a.pipelineName,n=c.getSelectedText();
if(c.getAttribute(c.getClosest(d.target,"button"),b.attributes.formBtn.key))m=c.getCursorCoordinates(),m.text=n,m.isInEditor=c.selectionIsInEditor(m),d.gutenSelection=m;else{for(g=0;g<k.beforeAny.length;g++)if(c.isFunction(k.beforeAny[g]))k.beforeAny[g](d,n,e);if(c.isFunction(k[h]))k[h](d,n,e);c.isFunction(a.func)&&(g=a.func(d,n||m&&m.text,e),n&&0<n.length&&g?c.replaceSelectedText(g):m&&m.isInEditor&&g?c.pasteHtml(m,g,!0):g&&c.pasteHtmlAtCursor(g,!0,d));for(g=0;g<k.afterAny.length;g++)if(c.isFunction(k.afterAny[g]))k.afterAny[g](d,
n,e);if(c.isFunction(k[l]))k[l](d,n,e)}};a.before&&k.registerPipelineEvent.registerBeforeComponentHandler(a.pipelineName,a.before);a.after&&k.registerPipelineEvent.registerAfterComponentHandler(a.pipelineName,a.after);a.form&&!d.displayHandler&&(d.displayHandler=function(){var f=e(d,a.form);if(c.exists(f.uniqueId)||b.attachFormsTo)if(c.exists(f.uniqueId)||"toolbar"!==b.attachFormsTo)c.exists(f.uniqueId)||c.insertNewElementInto({markup:f.form},b.attachFormsTo);else return{button:f.button,form:f.form};
else c.insertNewElementInto({markup:f.form},"body");return f.button});m=void 0;return d},makeComponentForm:p,addComponent:t}}});hilary.register("gutentyp::toolbar",{init:function(b,c,k){var h=k.getComponents(),e,g,n,l={},p,q,s,r,t,u,m;p=function(){c.insertNewElementBefore("div",b.selectors.newEditors,b.selectors.toolbar);c.insertHtml(b.selectors.newToolbars,'<div class="'+b.cssClasses.toolbarComponents+'"></div>');c.insertHtml(b.selectors.newToolbars,'<div class="'+b.cssClasses.toolbarForms+'"></div>')};q=function(){for(e=0;e<h.length;e++)void 0!==h[e].group?t(h[e]):c.isFunction(h[e].displayHandler)?r(h[e]):m(h[e])};s=function(){c.addClass(b.selectors.newEditors,
b.cssClasses.hasToolbar);c.addClass(b.selectors.newToolbars,b.cssClasses.hasComponents)};g=function(a){return b.selectors.toolbar+" ."+a.cssClass+":not("+b.selectors.hasEvents+")"};n=function(a,d){var c;c="gutentyp-component "+a.cssClass;d&&(c+=" "+d);return'<button type="button" class="'+c+'" data-title="'+a.title+'"><i class="'+b.cssClasses.toolbarBtnIcon+" "+a.icon+'"></i><span class="'+a.textClass+'">'+a.title+"</span></button>"};m=function(a){c.insertNewElementInto({markup:n(a)},b.selectors.newToolbarsComponentsContainer);
c.attachEvent({primarySelector:g(a),eventType:"click",eventHandler:a.execute})};r=function(a){var d=a.displayHandler();"string"===typeof d?c.insertHtml(b.selectors.newToolbarsComponentsContainer,d):(c.insertHtml(b.selectors.newToolbarsComponentsContainer,d.button),c.insertHtml(b.selectors.newToolbarsFormsContainer,d.form));c.attachEvent({primarySelector:g(a),eventType:"click",eventHandler:a.execute})};u=function(a){var d=l[a.group.name]={components:[a]};d.toggleId=c.getRandomString();d.menuId=c.getRandomString();
d.toggleSelector="."+d.toggleId;d.menuSelector="."+d.menuId;c.insertNewElementInto({markup:n(a.group,d.toggleId)},b.selectors.newToolbarsComponentsContainer);c.insertNewElementInto({markup:'<div class="'+d.menuId+" gutentyp-toolbar-group gutentyp-toolbar-arrow-"+(a.group.arrow||"over")+'"><ul></ul></div>'},"body");c.attachEvent({primarySelector:d.toggleSelector,eventType:"click",eventHandler:function(a){a=c.getClosest(a.target,"button");a=c.getCoordinates(a,d.menuSelector);var b;b="left: "+a.moveLeft+
"px";b+="; top: "+a.moveTop+"px";c.setStyle(d.menuSelector,b);c.toggleClass(".gutentyp-toolbar-group.active:not("+d.menuSelector+")","active");c.toggleClass(d.menuSelector,"active")}});return d};t=function(a){var b=c.getRandomString(),f="."+b,e;l[a.group.name]?(e=l[a.group.name],l[a.group.name].components.push(a)):e=u(a);a.displayHandler?c.insertNewElementInto({markup:"<li>"+a.displayHandler(b)+"</li>"},e.menuSelector+" ul"):c.insertNewElementInto({markup:"<li>"+n(a,b)+"</li>"},e.menuSelector+" ul");
c.attachEvent({primarySelector:f,eventType:"click",eventHandler:function(b,d){a.execute(b,d);c.toggleClass(e.menuSelector,"active")}})};return{build:function(){p();q();s()}}}});hilary.register("gutentyp::transformer",{init:function(b,c,k,h,e,g){g=g||{};return{transform:function(){c.initializeRichTextAreas();g.lazyToolbars?c.attachEvent({primarySelector:document,secondarySelector:b.selectors.editors,eventType:"focusin",eventHandler:function(b){h.build()}}):h.build();c.addChangeEventsToEditables(function(b){b&&c.updateTextarea(b)},!0);c.addClass(b.selectors.editor,b.cssClasses.hasEvents);e.registerPipelineEvent.registerAfterAnyHandler(function(b,e,g){if((b=c.getEditor(b.target))&&
